...
<img width="952" height="1024" alt="CDF6A66F59BFC5CC4FD7E53E09ED2922" src="https://github.com/user-attachments/assets/2cba5340-68df-49d2-ab25-f30112fbba59" />
...
校验脚本会检查清单格式、默认语言、本地化引用、脚本与图标文件、版本和名称/简短说明长度，并拒绝常见远程代码模式。GitHub Actions 会对每次推送和拉取请求执行同一检查。
