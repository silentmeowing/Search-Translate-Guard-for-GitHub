...
const requiredMessageKeys = [
  ...
  "pickerRepairInstruction", "pickerSelected", "pickerSuggested", "pickerObservedSuggestion", "pickerProtect", "pickerRepair", "pickerParent",
...
if (!siteContent.includes("// Source: src/mutation-risk-observer.js")) {
  fail("opt-in site content script must include mutation risk observation");
}
if (!siteContent.includes("// Source: src/composed-tree.js")) {
  fail("opt-in site content script must include open shadow tree support");
}
